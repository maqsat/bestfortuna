            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="ribbon-wrapper card">
                        ...
                        <p class="ribbon-content"> <a href="https://pay.kaspi.kz/pay/moxjvehp" target="_blank"> Ссылка для оплаты через Kaspi Pay(кроме Атырау)</a></p>
                        <p class="ribbon-content"> <a href="https://pay.kaspi.kz/pay/zilih4l6" target="_blank"> Ссылка для оплаты через Kaspi Pay(только Атырау)</a></p>
                        <p class="ribbon-content"> ТОО «Best Fortune»</p>
                        <p class="ribbon-content"> БИН </p>
                        <p class="ribbon-content"> Номер перевода </p>
                        <p class="ribbon-content"> Республика Казахстан, города Нур-Султан, ул. Кубрина 20/1 ВП6</p>
                    </div>
                </div>
                {{--<div class="col-md-6">
                    <div class="ribbon-wrapper card">

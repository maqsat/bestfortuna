        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-6 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Товар в подарок</h3>
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-addrow" class="table table-hover no-wrap contact-list" data-page-size="10">
                                    ...
                                    @foreach($list as $key => $item)
                                        @php $pv_all = Hierarchy::pvCounterAll($item->user_id) @endphp

                                        @if($pv_all >= 600 && $item->package_id == 2)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($pv_all >= 600 && $pv_all <= 799)
                                                        60$
                                                    @elseif($pv_all >= 800 && $pv_all <= 999)
                                                        80$
                                                    @elseif($pv_all >= 1000 )
                                                        100$
                                                    @else

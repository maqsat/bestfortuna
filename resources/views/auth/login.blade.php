...
@section('content')
    ...
    <section id="wrapper" class="login-register login-sidebar only-login-page"   style="background-image:url('bestfortune/bg.png');">
        <div class="login-box card p-t-30">
            <div class="card-block">
                    <form method="POST" action="{{ route('login') }}" class="form-horizontal form-material"  id="loginform" >
                        @csrf
                        <a href="javascript:void(0)" class="text-center db"><img src="bestfortune/logo.svg" alt="Home" style="width: 250px;" /></a>
